...
public class CurrentMovies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_movies);
        ...
        Log.d("LoginValue","The LoginValue is : " + i.getIntExtra("LoginValue",0)); // just to see if everything is working
